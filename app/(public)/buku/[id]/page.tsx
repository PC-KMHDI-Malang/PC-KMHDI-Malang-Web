...
export default async function EbookDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 py-16 transition-colors">
      <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8">
        <Link
          href="/buku"
          className="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 dark:text-slate-400 hover:text-red-700 dark:hover:text-rose-500 transition-colors mb-8"
        >
          <ArrowLeft size={16} />
          Kembali ke Koleksi
        </Link>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="w-8 h-8 flex items-center justify-center rounded-full bg-red-600 text-white group-hover:bg-red-700 transition-colors">
                        <Eye size={14} />
                      </span>
                    </div>
                  </div>
