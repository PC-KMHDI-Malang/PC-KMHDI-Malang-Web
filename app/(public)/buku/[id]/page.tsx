    ...
    <div className="-mt-32 bg-white">
      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-[minmax(0,320px)_1fr] gap-10">
          <div className="rounded-3xl bg-neutral-50 border border-neutral-200 p-8 flex items-center justify-center shadow-sm">
            <div className="relative w-40 sm:w-48 aspect-[3/4] shadow-[10px_10px_20px_rgba(0,0,0,0.15),-3px_0_5px_rgba(0,0,0,0.08)] rounded-r-xl rounded-l-sm">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-extrabold text-zinc-900 leading-snug">{ebook.title}</h1>

            <div className="mt-6 grid grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-neutral-500">Tahun Terbit</p>
                <p className="text-base font-bold text-zinc-800 mt-1">{ebook.publishYear || new Date(ebook.createdAt).getFullYear()}</p>
              </div>
              <div>
                <p className="text-sm text-neutral-500">Nama Penerbit</p>
                <p className="text-base font-bold text-zinc-800 mt-1">{ebook.publisher || "PP KMHDI"}</p>
              </div>
            </div>
            ...
            <div className="mt-10">
              <div className="flex items-center gap-6 border-b border-neutral-200">
                <span className="pb-3 text-sm font-bold text-red-600 border-b-2 border-red-600">Penjelasan</span>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-200 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div>
            <p className="text-sm font-semibold text-neutral-500 mb-2">Tag :</p>
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-neutral-100 text-neutral-700 rounded-full text-xs font-semibold">
              <Tag size={12} />
              {ebook.genre}
            </span>
          </div>
          ...
          <div>
            <p className="text-sm font-semibold text-neutral-500 mb-2 flex items-center gap-1.5 sm:justify-end">
              <Share2 size={14} />
              Bagikan:
            </p>
            <EbookShareBar
