  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage: "radial-gradient(ellipse 70% 60% at 20% 40%, rgba(153,27,27,0.65), transparent 70%), radial-gradient(ellipse 60% 50% at 90% 90%, rgba(251,191,36,0.16), transparent 70%)",
      }}
    >
      {/* Emblem */}
      ...
      <div style={{ display: "flex", flexDirection: "column", marginLeft: 64 }}>
        <div style={{ display: "flex", fontSize: 46, fontWeight: 700, color: "#ffffff", letterSpacing: -2 }}>Pimpinan Cabang</div>
        <div style={{ display: "flex", fontSize: 80, fontWeight: 700, color: "#fbbf24", marginTop: 4 }}>KMHDI Malang</div>
        <div style={{ display: "flex", width: 120, height: 6, backgroundColor: "#dc2626", borderRadius: 3, marginTop: 28 }} />
        <div style={{ display: "flex", fontSize: 30, color: "rgba(255,255,255,0.82)", marginTop: 28, lineHeight: 1.4, maxWidth: 620 }}>Kesatuan Mahasiswa Hindu Dharma Indonesia</div>
      </div>
    </div>,
    size,
  );
