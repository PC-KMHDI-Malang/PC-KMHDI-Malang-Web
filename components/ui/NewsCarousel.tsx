            ...
            <div key={item.id} className="min-w-0 flex-none w-full sm:w-1/2 lg:w-1/3 pl-4 md:pl-6 lg:pl-8">
              <article className="group h-full flex flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div className="p-6 flex flex-col grow">
                  ...
                  <h3 className="text-xl font-bold leading-snug text-slate-900 transition group-hover:text-red-700 mb-4 line-clamp-3">
                    {item.title}
                  </h3>
                  ...
                  <div className="mt-auto pt-4">
                    <Link
                      href={item.href}
                      className="inline-flex items-center gap-2 font-semibold text-red-700 transition hover:gap-3"
                    >
                      Baca Selengkapnya
                      <ArrowRight size={18} />
                    </Link>
