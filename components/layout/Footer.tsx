      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-6 leading-7 text-zinc-400">
              Website resmi Pengurus Cabang Kesatuan Mahasiswa
              Hindu Dharma Indonesia Kota Malang sebagai pusat
              informasi, publikasi, dan pelayanan organisasi.
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          ...
          <div className="flex flex-col items-center justify-between gap-4 text-center text-sm text-zinc-500 md:flex-row">
            ...
            <p>
              © {new Date().getFullYear()} PC KMHDI Malang.
              All Rights Reserved.
            </p>
