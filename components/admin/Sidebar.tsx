...
export default async function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-64 bg-white dark:bg-[#0a0a0a] text-slate-600 dark:text-slate-400 border-r border-slate-200 dark:border-white/5 h-screen fixed inset-y-0 left-0 flex-col shadow-xl z-20 transition-colors">
