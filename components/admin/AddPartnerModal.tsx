...
export function AddPartnerModal({ action, nextOrderIndex }: AddPartnerModalProps) {
        ...
        createPortal(
          <div className="fixed inset-y-0 right-0 left-0 md:left-64 z-[100] flex items-center justify-center p-4 text-left">
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-slate-800 dark:text-white mb-2">Tambah Mitra Baru</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm">Tambahkan logo lembaga/organisasi mitra kolaborasi.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-1.5">Logo Mitra</label>
                  <ImagePicker name="logoUrl" bucket="partner-logos" />
                </div>
