  ...
  features: [
    {
      ...
      description:
        "Membangun karakter, intelektualitas, dan kepemimpinan mahasiswa Hindu.",
    },
    {
      title: "Kolaborasi Luas",
      description:
        "Bersinergi dengan kampus, organisasi, pemerintah, dan masyarakat.",
    },
    {
      title: "Pengabdian Masyarakat",
      description:
        "Menghadirkan berbagai program sosial dan pelayanan kepada masyarakat.",
    },
    {
      title: "Nilai Dharma",
      description:
        "Menjadikan nilai-nilai Hindu sebagai landasan berpikir dan bertindak.",
    },
  ],
